...
public class SubCategoryRecyclerViewAdapter extends RecyclerView.Adapter<SubCategoryRecyclerViewAdapter.MyViewHolder>{
    ...
    public SubCategoryRecyclerViewAdapter(ArrayList<CategoryItems> arrayList, Context context){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, final int i) {
        ...
        myViewHolder.itemSubCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Serial",obj.getSerialNumber());
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        Animation animation = AnimationUtils.loadAnimation(myViewHolder.itemView.getContext(),android.R.anim.fade_in);
        animation.setDuration(1000);
        myViewHolder.itemView.setAnimation(animation);
